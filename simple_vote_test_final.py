#!/usr/bin/env python
"""
Final simple test for voting functionality in the Poller app.
...
def create_test_data():
    ...
    poll = Poll.objects.create(
        ...
        description="A simple test poll for voting functionality",
        created_by=user,
...
def test_voting():
    ...
    # Vote for the option using the simple vote view
    url = reverse("simple_vote", args=[poll.id])
